...
Premium features require a license — see [COMMERCIAL-LICENSING.md](COMMERCIAL-LICENSING.md). Customers download Premium from the license server only (no private GitHub access): [docs/PREMIUM-DISTRIBUTION.md](docs/PREMIUM-DISTRIBUTION.md).
